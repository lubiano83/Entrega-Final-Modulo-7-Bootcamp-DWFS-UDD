...
export default function Menu({ isDarkMode }) {
    ...
    return (
        <div className={`flex 2xl:flex-col 2xl:h-full justify-around items-center 2xl:w-56 w-full gap-2 ${isDarkMode ? "bg-amber-500 2xl:bg-amber-700" : "bg-green-500 2xl:bg-green-700"} text-white p-1`}>
            <Link to={"/about"}><p className={`cursor-pointer ${isDarkMode ? "hover:text-amber-950" : "hover:text-green-950"} font-bold`}>About</p></Link>
            ...
            <Link to={"/"}><p className={`cursor-pointer ${isDarkMode ? "hover:text-amber-950" : "hover:text-green-950"} font-bold`}>Lodges</p></Link>
