...
export default function About({ isDarkMode }) {
    ...
    return (
        <div className={`w-1/2 flex flex-col justify-center items-center gap-4 ${isDarkMode ? "bg-amber-100 shadow-amber-950" : "bg-green-100 shadow-green-950"} p-4 rounded-2xl shadow-sm max-w-3xl min-w-72`}>
            <Title isDarkMode={isDarkMode} >Las Trancas Lodges</Title>
